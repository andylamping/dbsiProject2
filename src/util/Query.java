...
writeSelectedDataAfterProjectionsOnRID(this.hashRecords);
return;
}
...
if(allRIDs.size() == 0){
	this.hashRecords = null;
	this.writeSelectedDataAfterProjectionsOnRID(this.hashRecords);
	return;
}
...
if(m == 1){
writeSelectedDataAfterProjectionsOnRecord(this.matchingRecords);
return;
}
